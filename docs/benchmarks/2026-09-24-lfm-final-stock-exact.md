# Tier 2 measurement, 2026-09-24: final-stock-exact

- Command: `scripts/lfm-finetune/measure.py --split $HOME/lfm-train/work/q46/splits/test.json --final --model stock --revision 2fc06364715b967f1860aea9cf38778875588b17 --label final-stock-exact --config $HOME/lfm-train/work/q46/measure/final-stock-exact.nvsh.toml --ctx 2048 --ground-snapshot $HOME/lfm-train/work/q46/ground-snapshot.json --enable-thinking false --max-logprobs 22 --predictions $HOME/lfm-train/work/q46/final/stock --tokenizer $HOME/lfm-train/work/q46/stock --scorer in-process`
...
- Acceptance run: no
- Final run: yes
- Final runs on the test side, including this one: 11
...
| Metric | `stock` |
|---|---|
| Right proposals (metrics.py) | 20 of 32 |
| Abstention recall (escalate entries escalated) | 0.0% (0 of 15) |
| Abstention precision, strict (deviation d2) | 0.0% |
| False-positive tool calls (proposals on explain/escalate entries) | 28 of 32 |
| Wrong mutating, total (wrong operation + wrong arguments) | 0 (0 + 0) |
| Invalid outputs | 3 of 64 (not_grounded: 3) |
| Lines with a candidate distribution | 64 of 64 |
| ECE (10 equal-width bins) | 0.167 |
| Brier (multi-class) | 0.834 |
| Tokens generated per decision, mean / median | 0.0 / 0.0 |
| Time to first decision, cold / warm median / warm p95 | 632 ms / 82 ms / 86 ms |
| Decision latency, cold / warm median / warm p95 | 632 ms / 82 ms / 86 ms |
...
4a2ab9f97a05   vllm/vllm-openai                 "vllm serve --model …"   2 minutes ago       Up 2 minutes          127.0.0.1:18060->8000/tcp                                                                            q46-measure-18060
...
|    0   N/A  N/A         2752707      C   VLLM::EngineCore                       8324MiB |
