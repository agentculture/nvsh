# Tier 2 measurement, 2026-09-24: final-a3.awq

- Command: `scripts/lfm-finetune/measure.py --split $HOME/lfm-train/work/q46/splits/test.json --final --model a3.awq --revision sha256:214e87f4cc241f2e --label final-a3.awq --config $HOME/lfm-train/work/q46/measure/final-a3.awq.nvsh.toml --ctx 2048 --ground-snapshot $HOME/lfm-train/work/q46/ground-snapshot.json --enable-thinking false --max-logprobs 22 --predictions $HOME/lfm-train/work/q46/final/a3.awq`
...
- Models (repo id @ revision): `a3.awq` @ `sha256:214e87f4cc241f2e` (operator-supplied, not verified: attached endpoint)
...
- Acceptance run: no
- Final run: yes
- Final runs on the test side, including this one: 12
...
| Should-escalate asks escalated, per source | 12 of 15 |
| Should-escalate asks escalated, per variation | 12 of 15 |
...
| Explain asks explained, per source | 17 of 17 |
| Explain asks: explained / proposed / escalated, per variation | 17 / 0 / 0 of 17 |
| Mutating proposals on explain asks | 0 |
| Warm latency, median / p95 | 295 ms / 518 ms |
...
| Tokens generated per decision, mean / median | 45.6 / 41.0 |
| Time to first decision, cold / warm median / warm p95 | 18393 ms / 295 ms / 517 ms |
| Decision latency, cold / warm median / warm p95 | 18394 ms / 295 ms / 518 ms |
| Non-empty think blocks (must be 0) | 0 |

- `a3.awq`: lines without a candidate distribution: an alternative token's continuation was not observed: 64
...
061d11e50e19   vllm/vllm-openai                 "vllm serve --model …"   2 minutes ago   Up 2 minutes          127.0.0.1:18060->8000/tcp                                                                            q46-measure-18060
93050d5259c1   climate-weather-tracker          "python -m climate.w…"   9 minutes ago   Up 9 minutes                                                                                                               weather-tracker
21571f98493d   climate-weather-web              "python -m climate.w…"   9 minutes ago   Up 9 minutes          127.0.0.1:8095->8095/tcp                                                                             weather-web
...
|    0   N/A  N/A         3025131      C   VLLM::EngineCore                       9080MiB |
