# Tier 2 measurement, 2026-09-24: final-scorer-b1-exact

- Command: `scripts/lfm-finetune/measure.py --split $HOME/lfm-train/work/q46/splits/test.json --final --model scorer-b1 --revision 541e1a9127b9682be883a517bb1c148aa6c79eb4 --label final-scorer-b1-exact --config $HOME/lfm-train/work/q46/measure/final-scorer-b1-exact.nvsh.toml --ctx 2048 --ground-snapshot $HOME/lfm-train/work/q46/ground-snapshot.json --enable-thinking false --max-logprobs 22 --predictions $HOME/lfm-train/work/q46/final/scorer-b1 --tokenizer $HOME/lfm-train/work/q46/runs/scorer-b1/merged --scorer in-process`
...
- Acceptance run: no
- Final run: yes
- Final runs on the test side, including this one: 9
...
| ECE (10 equal-width bins) | 0.132 |
| Brier (multi-class) | 0.268 |
| Tokens generated per decision, mean / median | 0.0 / 0.0 |
| Time to first decision, cold / warm median / warm p95 | 625 ms / 82 ms / 87 ms |
| Decision latency, cold / warm median / warm p95 | 625 ms / 82 ms / 87 ms |
...
21cfe9314ccb   vllm/vllm-openai                 "vllm serve --model …"   2 minutes ago    Up 2 minutes          127.0.0.1:18060->8000/tcp                                                                            q46-measure-18060
0205ea8dabbf   climate-weather-web              "python -m climate.w…"   57 minutes ago   Up 57 minutes         127.0.0.1:8095->8095/tcp                                                                             weather-web
93b52a3f60bb   climate-weather-tracker          "python -m climate.w…"   57 minutes ago   Up 57 minutes                                                                                                              weather-tracker
...
|    0   N/A  N/A         2714631      C   VLLM::EngineCore                       8686MiB |
