# Tier 2 measurement, 2026-09-25: final-scorer-r3b-exact

- Command: `scripts/lfm-finetune/measure.py --split $HOME/lfm-train/work/q53-run/splits/test.json --final --model scorer-r3b --revision 1299bc34fba808a3a740d8633ccebbfc6e5e60a7 --label final-scorer-r3b-exact --config $HOME/lfm-train/work/q53-run/measure/final-scorer-r3b-exact.nvsh.toml --ctx 2048 --ground-snapshot $HOME/lfm-train/work/q53-run/ground-snapshot.json --enable-thinking false --max-logprobs 20000 --predictions $HOME/lfm-train/work/q53-run/final/scorer-r3b --tokenizer $HOME/lfm-train/work/q53-run/runs/scorer-r3b/merged --scorer in-process`
...
- Models (repo id @ revision): `scorer-r3b` @ `1299bc34fba808a3a740d8633ccebbfc6e5e60a7` (passed to from_pretrained in-process)
...
- Decision mode: candidate scorer (in-process) through scorer.py, max-logprobs 20000 (operator-supplied); asks for 20000 per request
- Slice: full split
...
- Acceptance run: no
- Final run: yes
- Final runs on the test side, including this one: 21
...
| Abstention recall (escalate entries escalated) | 97.5% (77 of 79) |
| Abstention recall, 95% bootstrap CI | [93.7%, 100.0%] (n=79) |
| Abstention precision, strict (deviation d2) | 98.7% |
| Abstention precision, strict, 95% bootstrap CI | [96.2%, 100.0%] (n=198) |
...
| Invalid outputs | 2 of 198 (not_grounded: 2) |
| Invalid outputs, 95% bootstrap CI | [0.0%, 2.5%] (n=198) |
| Lines with a candidate distribution | 198 of 198 |
| Scorer readouts, complete / incomplete (never renormalised) | 198 / 0 |
| ECE (10 equal-width bins) | 0.023 |
| ECE, 95% bootstrap CI | [0.006, 0.046] (n=198) |
| Brier (multi-class) | 0.047 |
| Brier, 95% bootstrap CI | [0.012, 0.090] (n=198) |
| ECE / Brier before --calibration | n/a |
| Tokens generated per decision, mean / median | 0.0 / 0.0 |
| Time to first decision, cold / warm median / warm p95 | 641 ms / 83 ms / 87 ms |
| Decision latency, cold / warm median / warm p95 | 641 ms / 83 ms / 87 ms |
...
|---|---|---|---|---|---|---|
| read_only | 71 | 71 | 0.034 [0.001, 0.076] (n=71) | 0.072 [0.000, 0.156] (n=71) | 0 of 71 [0.0%, 0.0%] (n=71) | 18.0 / 18.0 |
| mutating | 12 | 12 | 0.005 [0.001, 0.011] (n=12) | 0.000 [0.000, 0.001] (n=12) | 0 of 12 [0.0%, 0.0%] (n=12) | 18.0 / 18.0 |
| escalate_or_explain | 115 | 115 | 0.020 [0.005, 0.045] (n=115) | 0.036 [0.002, 0.084] (n=115) | 0 of 115 [0.0%, 0.0%] (n=115) | 18.0 / 18.0 |
...
| [0.2, 0.3) | 0 | - | - |
| [0.3, 0.4) | 0 | - | - |
| [0.4, 0.5) | 1 | 0.491 | 0.000 |
| [0.5, 0.6) | 0 | - | - |
| [0.6, 0.7) | 0 | - | - |
| [0.7, 0.8) | 0 | - | - |
| [0.8, 0.9) | 0 | - | - |
| [0.9, 1.0) | 70 | 0.999 | 0.971 |
...
fa5625b046a5   vllm/vllm-openai                 "vllm serve --model …"   2 minutes ago   Up 2 minutes            127.0.0.1:18060->8000/tcp                                                                            q46-measure-18060
...
|    0   N/A  N/A           10315      G   /usr/bin/ghostty                        824MiB |
|    0   N/A  N/A          147875      G   ...rack-uuid=3190708988185955192        374MiB |
|    0   N/A  N/A         1263722      C   VLLM::EngineCore                       8914MiB |
