...
- Acceptance run: no
- Final run: yes
- Final runs on the test side, including this one: 7
...
| Time to first decision, cold / warm median / warm p95 | 18381 ms / 23 ms / 26 ms |
| Decision latency, cold / warm median / warm p95 | 18381 ms / 23 ms / 26 ms |
| Non-empty think blocks (must be 0) | 0 |

- `scorer-b1`: lines without a candidate distribution: labels missing from the top log-probabilities: 64
...
7f14fa6ef583   vllm/vllm-openai                 "vllm serve --model …"   2 minutes ago    Up 2 minutes          127.0.0.1:18060->8000/tcp                                                                            q46-measure-18060
0205ea8dabbf   climate-weather-web              "python -m climate.w…"   49 minutes ago   Up 49 minutes         127.0.0.1:8095->8095/tcp                                                                             weather-web
93b52a3f60bb   climate-weather-tracker          "python -m climate.w…"   49 minutes ago   Up 49 minutes                                                                                                              weather-tracker
...
|    0   N/A  N/A         2691375      C   VLLM::EngineCore                       7846MiB |
