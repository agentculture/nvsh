# Tier 2 measurement, 2026-09-24: final-scorer-b1.awq

- Command: `scripts/lfm-finetune/measure.py --split $HOME/lfm-train/work/q46/splits/test.json --final --model scorer-b1.awq --revision sha256:8a0d872e089aaaa6 --label final-scorer-b1.awq --config $HOME/lfm-train/work/q46/measure/final-scorer-b1.awq.nvsh.toml --ctx 2048 --ground-snapshot $HOME/lfm-train/work/q46/ground-snapshot.json --enable-thinking false --max-logprobs 22 --predictions $HOME/lfm-train/work/q46/final/scorer-b1.awq --tokenizer $HOME/lfm-train/work/q46/quant/scorer-b1/awq --scorer served`
- Split: `$HOME/lfm-train/work/q46/splits/test.json` (64 entries, 64 sources)
- Seed: 46 (from the split header)
- nvsh: 0.18.0, commit `93e25df746aef08acc9c6a9cbf596dcba033b9b2`
- Models (repo id @ revision): `scorer-b1.awq` @ `sha256:8a0d872e089aaaa6` (operator-supplied, not verified: attached endpoint)
...
- Acceptance run: no
- Final run: yes
- Final runs on the test side, including this one: 13
...
| Time to first decision, cold / warm median / warm p95 | 18572 ms / 22 ms / 26 ms |
| Decision latency, cold / warm median / warm p95 | 18572 ms / 22 ms / 26 ms |
| Non-empty think blocks (must be 0) | 0 |

- `scorer-b1.awq`: lines without a candidate distribution: labels missing from the top log-probabilities: 64
...
8c20ef3f9194   vllm/vllm-openai                 "vllm serve --model …"   2 minutes ago    Up 2 minutes          127.0.0.1:18060->8000/tcp                                                                            q46-measure-18060
93050d5259c1   climate-weather-tracker          "python -m climate.w…"   12 minutes ago   Up 11 minutes                                                                                                              weather-tracker
21571f98493d   climate-weather-web              "python -m climate.w…"   12 minutes ago   Up 11 minutes         127.0.0.1:8095->8095/tcp                                                                             weather-web
...
|    0   N/A  N/A         3039606      C   VLLM::EngineCore                       5996MiB |
