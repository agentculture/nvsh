# Tier 2 measurement, 2026-09-24: final-scorer-b1-missing-candidate

- Command: `scripts/lfm-finetune/measure.py --split $HOME/lfm-train/work/q46/splits/test.json --final --model scorer-b1 --revision 541e1a9127b9682be883a517bb1c148aa6c79eb4 --label final-scorer-b1-missing-candidate --config $HOME/lfm-train/work/q46/measure/final-scorer-b1-missing-candidate.nvsh.toml --ctx 2048 --ground-snapshot $HOME/lfm-train/work/q46/ground-snapshot.json --enable-thinking false --max-logprobs 22 --predictions $HOME/lfm-train/work/q46/final/scorer-b1 --tokenizer $HOME/lfm-train/work/q46/runs/scorer-b1/merged --slice missing-candidate --scorer served`
...
- Acceptance run: no
- Final run: yes
- Final runs on the test side, including this one: 8
...
| Time to first decision, cold / warm median / warm p95 | 16863 ms / 21 ms / 23 ms |
| Decision latency, cold / warm median / warm p95 | 16863 ms / 21 ms / 23 ms |
| Non-empty think blocks (must be 0) | 0 |

- `scorer-b1`: lines without a candidate distribution: labels missing from the top log-probabilities: 32
...
a541c499bc5c   vllm/vllm-openai                 "vllm serve --model …"   2 minutes ago    Up 2 minutes          127.0.0.1:18060->8000/tcp                                                                            q46-measure-18060
0205ea8dabbf   climate-weather-web              "python -m climate.w…"   52 minutes ago   Up 52 minutes         127.0.0.1:8095->8095/tcp                                                                             weather-web
93b52a3f60bb   climate-weather-tracker          "python -m climate.w…"   52 minutes ago   Up 52 minutes                                                                                                              weather-tracker
...
|    0   N/A  N/A         2699095      C   VLLM::EngineCore                       9202MiB |
