# Tier 2 measurement, 2026-09-25: edge-orin-scorer-r3b.q4_k_m-test-mc

- Command: `scripts/lfm-finetune/measure.py --split $HOME/lfm-edge/q53/work/splits/test.json --model scorer-r3b.q4_k_m --revision sha256:3568f660ab186887 --label edge-orin-scorer-r3b.q4_k_m-test-mc --config $HOME/lfm-edge/q53/out/scorer-r3b.q4_k_m.toml --ctx 2048 --ground-snapshot $HOME/lfm-edge/q53/work/ground-snapshot.json --enable-thinking false --max-logprobs 20000 --scorer served --tokenizer $HOME/lfm-edge/q53/tok/scorer-r3b --slice missing-candidate --final --out $HOME/lfm-edge/q53/out/edge-orin-scorer-r3b.q4_k_m-test-mc.md --predictions $HOME/lfm-edge/q53/out/pred`
- Split: `$HOME/lfm-edge/q53/work/splits/test.json` (83 entries, 83 sources)
...
| Abstention recall (escalate entries escalated) | 80.7% (67 of 83) |
| Abstention recall, 95% bootstrap CI | [72.3%, 89.2%] (n=83) |
...
| ECE (10 equal-width bins) | 0.144 |
| ECE, 95% bootstrap CI | [0.086, 0.228] (n=83) |
| Brier (multi-class) | 0.296 |
| Brier, 95% bootstrap CI | [0.169, 0.431] (n=83) |
| ECE / Brier before --calibration | n/a |
| Tokens generated per decision, mean / median | 0.0 / 0.0 |
| Time to first decision, cold / warm median / warm p95 | 355 ms / 348 ms / 362 ms |
| Decision latency, cold / warm median / warm p95 | 355 ms / 348 ms / 362 ms |
...
| escalate_or_explain | 83 | 83 | 0.144 [0.086, 0.228] (n=83) | 0.296 [0.169, 0.431] (n=83) | 83 of 83 [100.0%, 100.0%] (n=83) | 17.0 / 17.0 |
...
| [0.3, 0.4) | 0 | - | - |
| [0.4, 0.5) | 0 | - | - |
| [0.5, 0.6) | 2 | 0.522 | 0.000 |
| [0.6, 0.7) | 2 | 0.641 | 0.000 |
| [0.7, 0.8) | 5 | 0.764 | 0.600 |
| [0.8, 0.9) | 5 | 0.867 | 0.800 |
| [0.9, 1.0) | 69 | 0.993 | 0.870 |
