# Tier 2 measurement, 2026-09-24: heldout-stock

- Command: `scripts/lfm-finetune/measure.py --split $HOME/lfm-train/work/heldout-q46/held-out-q46.sealed.json --acceptance --model stock --revision 2fc06364715b967f1860aea9cf38778875588b17 --label heldout-stock --config $HOME/lfm-train/work/q46/measure/heldout-stock.nvsh.toml --ctx 2048 --ground-snapshot $HOME/lfm-train/work/q46/ground-snapshot.json --enable-thinking false --max-logprobs 22 --predictions $HOME/lfm-train/work/q46/final/stock`
...
| Right operation and arguments proposed, per source | 4 of 41 |
| Right operation and arguments proposed, per variation | 4 of 41 |
| Should-escalate asks escalated, per source | 10 of 13 |
| Should-escalate asks escalated, per variation | 10 of 13 |
...
| Explain asks explained, per source | 8 of 15 |
| Explain asks: explained / proposed / escalated, per variation | 8 / 1 / 6 of 15 |
| Mutating proposals on explain asks | 1 |
| Warm latency, median / p95 | 1006 ms / 2274 ms |
| First request after start | 17.5 s |
...
| Metric | `stock` |
|---|---|
| Right proposals (metrics.py) | 6 of 41 |
| Abstention recall (escalate entries escalated) | 7.7% (1 of 13) |
| Abstention precision, strict (deviation d2) | 25.0% |
| False-positive tool calls (proposals on explain/escalate entries) | 5 of 28 |
| Wrong mutating, total (wrong operation + wrong arguments) | 4 (4 + 0) |
| Invalid outputs | 40 of 69 (no_decision: 40) |
| Lines with a candidate distribution | 0 of 69 |
| ECE (10 equal-width bins) | n/a |
| Brier (multi-class) | n/a |
| Tokens generated per decision, mean / median | 98.9 / 88.0 |
| Time to first decision, cold / warm median / warm p95 | 16928 ms / 182 ms / 1501 ms |
| Decision latency, cold / warm median / warm p95 | 17485 ms / 1006 ms / 2273 ms |
| Non-empty think blocks (must be 0) | 0 |

- `stock`: lines without a candidate distribution: an alternative token's continuation was not observed: 25; invalid output: 40; no tool call in the deciding reply: 4
...
368bc018468f   vllm/vllm-openai                 "vllm serve --model …"   2 minutes ago    Up 2 minutes          127.0.0.1:18060->8000/tcp                                                                            q46-measure-18060
0205ea8dabbf   climate-weather-web              "python -m climate.w…"   37 minutes ago   Up 37 minutes         127.0.0.1:8095->8095/tcp                                                                             weather-web
93b52a3f60bb   climate-weather-tracker          "python -m climate.w…"   37 minutes ago   Up 37 minutes                                                                                                              weather-tracker
...
| N/A   52C    P0             13W /  N/A  | Not Supported          |      3%      Default |
|                                         |                        |                  N/A |
+-----------------------------------------+------------------------+----------------------+
...
|    0   N/A  N/A            8320      G   /usr/bin/gnome-shell                    205MiB |
|    0   N/A  N/A            8856      G   ...exec/xdg-desktop-portal-gnome         57MiB |
|    0   N/A  N/A           10315      G   /usr/bin/ghostty                        835MiB |
|    0   N/A  N/A          147875      G   ...rack-uuid=3190708988185955192        181MiB |
|    0   N/A  N/A         2654310      C   VLLM::EngineCore                       8612MiB |
