# Jetson skill-routing measurement -- stock, 2026-09-22

## Run

- command: `measure_skills.py --tools $HOME/lfm-train/jetson/tools.json --test $HOME/lfm-train/jetson/test.jsonl --model LiquidAI/LFM2.5-350M --model-revision 9e6c6ccf47cd318696e137d381a7ded8fe4df09f --manifest $HOME/lfm-train/jetson/manifest.json --label stock --launch --config $HOME/lfm-train/measure-config.toml`
- date: 2026-09-22
