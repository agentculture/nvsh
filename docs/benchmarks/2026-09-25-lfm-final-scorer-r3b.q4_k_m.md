# Tier 2 measurement, 2026-09-25: final-scorer-r3b.q4_k_m

- Command: `scripts/lfm-finetune/measure.py --split $HOME/lfm-train/work/q53-run/splits/test.json --final --model scorer-r3b.q4_k_m --revision sha256:52061cec322242c4 --label final-scorer-r3b.q4_k_m --config $HOME/lfm-train/work/q53-run/measure/final-scorer-r3b.q4_k_m.nvsh.toml --ctx 2048 --ground-snapshot $HOME/lfm-train/work/q53-run/ground-snapshot.json --enable-thinking false --max-logprobs 20000 --predictions $HOME/lfm-train/work/q53-run/final/scorer-r3b.q4_k_m --tokenizer $HOME/lfm-train/work/q53-run/runs/scorer-r3b/merged --scorer served`
- Split: `$HOME/lfm-train/work/q53-run/splits/test.json` (198 entries, 198 sources)
...
- Tier 2 settings, identical for every run except the model: engine=llama-server, mode=attach, image=native llama-server $HOME/lfm-train/llama.cpp/build/bin/llama-server (0.00.000.469 I srv llama_server: initializing ... version: 0.4.1-dev (build 11132, commit 633733d0a) built with GNU 13.3.0 for Linux aarch64), ctx=2048, tool_call_parser=qwen3_coder
...
- Serving: engine=llama-server, mode=attach, ctx=2048, image=`native llama-server $HOME/lfm-train/llama.cpp/build/bin/llama-server (0.00.000.469 I srv llama_server: initializing ... version: 0.4.1-dev (build 11132, commit 633733d0a) built with GNU 13.3.0 for Linux aarch64)`, tool_call_parser=qwen3_coder
...
- Acceptance run: no
- Final run: yes
- Final runs on the test side, including this one: 19
...
|---|---|
| Right proposals (metrics.py) | 79 of 83 |
| Right proposals, 95% bootstrap CI | [90.4%, 98.8%] (n=83) |
| Abstention recall (escalate entries escalated) | 94.9% (75 of 79) |
| Abstention recall, 95% bootstrap CI | [89.9%, 98.7%] (n=79) |
| Abstention precision, strict (deviation d2) | 98.7% |
| Abstention precision, strict, 95% bootstrap CI | [96.1%, 100.0%] (n=198) |
| False-positive tool calls (proposals on explain/escalate entries) | 1 of 115 |
| False-positive tool calls, 95% bootstrap CI | [0.0%, 2.6%] (n=115) |
| Wrong mutating, total (wrong operation + wrong arguments) | 0 (0 + 0) |
| Invalid outputs | 3 of 198 (not_grounded: 3) |
| Invalid outputs, 95% bootstrap CI | [0.0%, 3.5%] (n=198) |
| Lines with a candidate distribution | 198 of 198 |
| Scorer readouts, complete / incomplete (never renormalised) | 198 / 0 |
| ECE (10 equal-width bins) | 0.028 |
| ECE, 95% bootstrap CI | [0.009, 0.053] (n=198) |
| Brier (multi-class) | 0.051 |
| Brier, 95% bootstrap CI | [0.016, 0.095] (n=198) |
| ECE / Brier before --calibration | n/a |
| Tokens generated per decision, mean / median | 0.0 / 0.0 |
| Time to first decision, cold / warm median / warm p95 | 169 ms / 124 ms / 156 ms |
| Decision latency, cold / warm median / warm p95 | 169 ms / 124 ms / 156 ms |
...
|---|---|---|---|---|---|---|
| read_only | 71 | 71 | 0.034 [0.004, 0.078] (n=71) | 0.065 [0.001, 0.149] (n=71) | 0 of 71 [0.0%, 0.0%] (n=71) | 18.0 / 18.0 |
| mutating | 12 | 12 | 0.006 [0.001, 0.012] (n=12) | 0.000 [0.000, 0.001] (n=12) | 0 of 12 [0.0%, 0.0%] (n=12) | 18.0 / 18.0 |
| escalate_or_explain | 115 | 115 | 0.029 [0.007, 0.057] (n=115) | 0.048 [0.008, 0.098] (n=115) | 0 of 115 [0.0%, 0.0%] (n=115) | 18.0 / 18.0 |
...
| [0.2, 0.3) | 0 | - | - |
| [0.3, 0.4) | 0 | - | - |
| [0.4, 0.5) | 1 | 0.433 | 0.000 |
| [0.5, 0.6) | 0 | - | - |
| [0.6, 0.7) | 0 | - | - |
| [0.7, 0.8) | 0 | - | - |
| [0.8, 0.9) | 1 | 0.856 | 1.000 |
| [0.9, 1.0) | 69 | 0.997 | 0.971 |
...
| [0.4, 0.5) | 0 | - | - |
| [0.5, 0.6) | 0 | - | - |
| [0.6, 0.7) | 2 | 0.659 | 0.000 |
| [0.7, 0.8) | 0 | - | - |
| [0.8, 0.9) | 2 | 0.873 | 1.000 |
| [0.9, 1.0) | 111 | 0.997 | 0.982 |
...
|    0   N/A  N/A          147875      G   ...rack-uuid=3190708988185955192        376MiB |
|    0   N/A  N/A         1256838      C   ...ma.cpp/build/bin/llama-server        829MiB |
