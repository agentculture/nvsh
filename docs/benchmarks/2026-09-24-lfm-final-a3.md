# Tier 2 measurement, 2026-09-24: final-a3

- Command: `scripts/lfm-finetune/measure.py --split $HOME/lfm-train/work/q46/splits/test.json --final --model a3 --revision d0303706be884c81e3e72d32042be96d621e160d --label final-a3 --config $HOME/lfm-train/work/q46/measure/final-a3.nvsh.toml --ctx 2048 --ground-snapshot $HOME/lfm-train/work/q46/ground-snapshot.json --enable-thinking false --max-logprobs 22 --predictions $HOME/lfm-train/work/q46/final/a3`
...
- Acceptance run: no
- Final run: yes
- Final runs on the test side, including this one: 5
...
| Warm latency, median / p95 | 443 ms / 717 ms |
| First request after start | 18.3 s |
...
| Tokens generated per decision, mean / median | 45.8 / 40.0 |
| Time to first decision, cold / warm median / warm p95 | 18347 ms / 442 ms / 716 ms |
| Decision latency, cold / warm median / warm p95 | 18348 ms / 442 ms / 716 ms |
| Non-empty think blocks (must be 0) | 0 |

- `a3`: lines without a candidate distribution: an alternative token's continuation was not observed: 64
...
71b17e22a68f   vllm/vllm-openai                 "vllm serve --model …"   2 minutes ago    Up 2 minutes          127.0.0.1:18060->8000/tcp                                                                            q46-measure-18060
0205ea8dabbf   climate-weather-web              "python -m climate.w…"   41 minutes ago   Up 41 minutes         127.0.0.1:8095->8095/tcp                                                                             weather-web
93b52a3f60bb   climate-weather-tracker          "python -m climate.w…"   41 minutes ago   Up 41 minutes                                                                                                              weather-tracker
...
| N/A   53C    P0             13W /  N/A  | Not Supported          |      3%      Default |
|                                         |                        |                  N/A |
+-----------------------------------------+------------------------+----------------------+
...
|    0   N/A  N/A         2665647      C   VLLM::EngineCore                       8890MiB |
