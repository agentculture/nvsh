# Tier 2 measurement, 2026-09-24: heldout-stock-exact

- Command: `scripts/lfm-finetune/measure.py --split $HOME/lfm-train/work/heldout-q46/held-out-q46.sealed.json --acceptance --model stock --revision 2fc06364715b967f1860aea9cf38778875588b17 --label heldout-stock-exact --config $HOME/lfm-train/work/q46/measure/heldout-stock-exact.nvsh.toml --ctx 2048 --ground-snapshot $HOME/lfm-train/work/q46/ground-snapshot.json --enable-thinking false --max-logprobs 22 --predictions $HOME/lfm-train/work/q46/final/stock --tokenizer $HOME/lfm-train/work/q46/stock --scorer in-process`
...
- Models (repo id @ revision): `stock` @ `2fc06364715b967f1860aea9cf38778875588b17` (passed to from_pretrained in-process)
...
| Metric | `stock` |
|---|---|
| Right proposals (metrics.py) | 22 of 41 |
| Abstention recall (escalate entries escalated) | 7.7% (1 of 13) |
| Abstention precision, strict (deviation d2) | 100.0% |
| False-positive tool calls (proposals on explain/escalate entries) | 26 of 28 |
| Wrong mutating, total (wrong operation + wrong arguments) | 0 (0 + 0) |
| Invalid outputs | 2 of 69 (not_grounded: 2) |
| Lines with a candidate distribution | 69 of 69 |
| ECE (10 equal-width bins) | 0.169 |
| Brier (multi-class) | 0.803 |
| Tokens generated per decision, mean / median | 0.0 / 0.0 |
| Time to first decision, cold / warm median / warm p95 | 625 ms / 83 ms / 86 ms |
| Decision latency, cold / warm median / warm p95 | 625 ms / 83 ms / 86 ms |
...
dba80906869e   vllm/vllm-openai                 "vllm serve --model …"   2 minutes ago       Up 2 minutes          127.0.0.1:18060->8000/tcp                                                                            q46-measure-18060
0205ea8dabbf   climate-weather-web              "python -m climate.w…"   About an hour ago   Up About an hour      127.0.0.1:8095->8095/tcp                                                                             weather-web
93b52a3f60bb   climate-weather-tracker          "python -m climate.w…"   About an hour ago   Up About an hour                                                                                                           weather-tracker
...
|    0   N/A  N/A          147875      G   ...rack-uuid=3190708988185955192        227MiB |
|    0   N/A  N/A         2760735      C   VLLM::EngineCore                       6488MiB |
