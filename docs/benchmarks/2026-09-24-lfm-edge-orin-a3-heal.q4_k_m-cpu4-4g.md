# Tier 2 measurement, 2026-09-24: edge-orin-a3-heal.q4_k_m-cpu4-4g

- Command: `scripts/lfm-finetune/measure.py --split $HOME/lfm-edge/q46/work/splits/val.json --model a3-heal.q4_k_m --revision sha256:8bd6ebe4009ac90d --label edge-orin-a3-heal.q4_k_m-cpu4-4g --config $HOME/lfm-edge/q46/out/a3-heal.q4_k_m.toml --ctx 2048 --ground-snapshot $HOME/lfm-edge/q46/work/ground-snapshot.json --enable-thinking false --max-logprobs 22 --out $HOME/lfm-edge/q46/out/edge-orin-a3-heal.q4_k_m-cpu4-4g.md --predictions $HOME/lfm-edge/q46/out/pred`
...
| Warm latency, median / p95 | 2852 ms / 4177 ms |
| First request after start | 3.5 s |
...
| Tokens generated per decision, mean / median | 45.0 / 40.0 |
| Time to first decision, cold / warm median / warm p95 | 3510 ms / 2851 ms / 4175 ms |
| Decision latency, cold / warm median / warm p95 | 3511 ms / 2852 ms / 4177 ms |
...
ef6fcb96f1b3   f7c67c102b08         "llama-server --mode…"   5 seconds ago   Up 4 seconds            127.0.0.1:18090->8080/tcp                     q46-edge
