# Tier 2 measurement, 2026-09-24: final-stock-missing-candidate

- Command: `scripts/lfm-finetune/measure.py --split $HOME/lfm-train/work/q46/splits/test.json --final --model stock --revision 2fc06364715b967f1860aea9cf38778875588b17 --label final-stock-missing-candidate --config $HOME/lfm-train/work/q46/measure/final-stock-missing-candidate.nvsh.toml --ctx 2048 --ground-snapshot $HOME/lfm-train/work/q46/ground-snapshot.json --enable-thinking false --max-logprobs 22 --predictions $HOME/lfm-train/work/q46/final/stock --slice missing-candidate`
...
- Acceptance run: no
- Final run: yes
- Final runs on the test side, including this one: 4
...
| Should-escalate asks escalated, per source | 26 of 32 |
| Should-escalate asks escalated, per variation | 26 of 32 |
...
| Warm latency, median / p95 | 747 ms / 2877 ms |
...
| Abstention recall (escalate entries escalated) | 3.1% (1 of 32) |
...
| Invalid outputs | 23 of 32 (no_decision: 23) |
| Lines with a candidate distribution | 0 of 32 |
| ECE (10 equal-width bins) | n/a |
| Brier (multi-class) | n/a |
| Tokens generated per decision, mean / median | 87.1 / 60.0 |
| Time to first decision, cold / warm median / warm p95 | 18236 ms / 216 ms / 2302 ms |
| Decision latency, cold / warm median / warm p95 | 18774 ms / 746 ms / 2876 ms |
| Non-empty think blocks (must be 0) | 0 |

- `stock`: lines without a candidate distribution: an alternative token's continuation was not observed: 7; invalid output: 23; no tool call in the deciding reply: 2
...
444f5ecc7aae   vllm/vllm-openai                 "vllm serve --model …"   2 minutes ago    Up 2 minutes          127.0.0.1:18060->8000/tcp                                                                            q46-measure-18060
0205ea8dabbf   climate-weather-web              "python -m climate.w…"   34 minutes ago   Up 34 minutes         127.0.0.1:8095->8095/tcp                                                                             weather-web
93b52a3f60bb   climate-weather-tracker          "python -m climate.w…"   34 minutes ago   Up 34 minutes                                                                                                              weather-tracker
...
| N/A   53C    P0             13W /  N/A  | Not Supported          |      4%      Default |
|                                         |                        |                  N/A |
+-----------------------------------------+------------------------+----------------------+
...
|    0   N/A  N/A            8099      G   /usr/lib/xorg/Xorg                      342MiB |
|    0   N/A  N/A            8320      G   /usr/bin/gnome-shell                    204MiB |
|    0   N/A  N/A            8856      G   ...exec/xdg-desktop-portal-gnome         57MiB |
|    0   N/A  N/A           10315      G   /usr/bin/ghostty                        836MiB |
|    0   N/A  N/A          147875      G   ...rack-uuid=3190708988185955192        215MiB |
|    0   N/A  N/A         2644310      C   VLLM::EngineCore                       8216MiB |
