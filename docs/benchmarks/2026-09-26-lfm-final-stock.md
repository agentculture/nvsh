# Tier 2 measurement, 2026-09-26: final-stock

- Command: `scripts/lfm-finetune/measure.py --split $HOME/lfm-train/work/i64-a3heal/splits/test.json --final --model stock --revision 2fc06364715b967f1860aea9cf38778875588b17 --label final-stock --config $HOME/lfm-train/work/i64-a3heal/measure/final-stock.nvsh.toml --ctx 2048 --ground-snapshot $HOME/lfm-train/work/q53-run/ground-snapshot.json --enable-thinking false --max-logprobs 22 --predictions $HOME/lfm-train/work/i64-a3heal/final/stock`
- Split: `$HOME/lfm-train/work/i64-a3heal/splits/test.json` (198 entries, 198 sources)
- Seed: 53 (from the split header)
- nvsh: 0.20.0, commit `425c03f6eaab65f6ac01baf85f64fa849ba0ef56`
...
- Acceptance run: no
- Final run: yes
- Final runs on the test side, including this one: 27
...
| Right operation and arguments proposed, per source | 6 of 83 |
| Right operation and arguments proposed, per variation | 6 of 83 |
| Should-escalate asks escalated, per source | 43 of 79 |
| Should-escalate asks escalated, per variation | 43 of 79 |
...
| Explain asks explained, per source | 24 of 36 |
| Explain asks: explained / proposed / escalated, per variation | 24 / 1 / 11 of 36 |
| Mutating proposals on explain asks | 1 |
| Warm latency, median / p95 | 743 ms / 2003 ms |
| First request after start | 18.0 s |
...
| Metric | `stock` |
|---|---|
| Right proposals (metrics.py) | 6 of 83 |
| Right proposals, 95% bootstrap CI | [2.4%, 13.3%] (n=83) |
| Abstention recall (escalate entries escalated) | 3.8% (3 of 79) |
| Abstention recall, 95% bootstrap CI | [0.0%, 8.9%] (n=79) |
| Abstention precision, strict (deviation d2) | 33.3% |
| Abstention precision, strict, 95% bootstrap CI | [0.0%, 66.7%] (n=198) |
| False-positive tool calls (proposals on explain/escalate entries) | 14 of 115 |
| False-positive tool calls, 95% bootstrap CI | [6.1%, 18.3%] (n=115) |
| Wrong mutating, total (wrong operation + wrong arguments) | 5 (5 + 0) |
| Invalid outputs | 86 of 198 (no_decision: 86) |
| Invalid outputs, 95% bootstrap CI | [36.4%, 50.5%] (n=198) |
| Lines with a candidate distribution | 0 of 198 |
...
| Tokens generated per decision, mean / median | 91.8 / 73.0 |
| Time to first decision, cold / warm median / warm p95 | 17991 ms / 184 ms / 1453 ms |
| Decision latency, cold / warm median / warm p95 | 17992 ms / 743 ms / 2003 ms |
| Non-empty think blocks (must be 0) | 0 |

- `stock`: lines without a candidate distribution: an alternative token's continuation was not observed: 78; invalid output: 86; no tool call in the deciding reply: 34
...
|---|---|---|---|---|---|---|
| read_only | 71 | 0 | n/a (n=0) | n/a (n=0) | 0 of 71 [0.0%, 0.0%] (n=71) | n/a / n/a |
| mutating | 12 | 0 | n/a (n=0) | n/a (n=0) | 0 of 12 [0.0%, 0.0%] (n=12) | n/a / n/a |
| escalate_or_explain | 115 | 0 | n/a (n=0) | n/a (n=0) | 0 of 115 [0.0%, 0.0%] (n=115) | n/a / n/a |
...
647d6d037a03   vllm/vllm-openai                 "vllm serve --model …"   2 minutes ago   Up 2 minutes          127.0.0.1:18060->8000/tcp                                                                            q46-measure-18060
...
|    0   N/A  N/A         4060149      C   VLLM::EngineCore                       9056MiB |
+-----------------------------------------------------------------------------------------+
```
