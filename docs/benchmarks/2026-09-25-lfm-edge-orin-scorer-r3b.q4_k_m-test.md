# Tier 2 measurement, 2026-09-25: edge-orin-scorer-r3b.q4_k_m-test

- Command: `scripts/lfm-finetune/measure.py --split $HOME/lfm-edge/q53/work/splits/test.json --model scorer-r3b.q4_k_m --revision sha256:3568f660ab186887 --label edge-orin-scorer-r3b.q4_k_m-test --config $HOME/lfm-edge/q53/out/scorer-r3b.q4_k_m.toml --ctx 2048 --ground-snapshot $HOME/lfm-edge/q53/work/ground-snapshot.json --enable-thinking false --max-logprobs 20000 --scorer served --tokenizer $HOME/lfm-edge/q53/tok/scorer-r3b --slice full --final --out $HOME/lfm-edge/q53/out/edge-orin-scorer-r3b.q4_k_m-test.md --predictions $HOME/lfm-edge/q53/out/pred`
- Split: `$HOME/lfm-edge/q53/work/splits/test.json` (198 entries, 198 sources)
...
- Acceptance run: no
- Final run: yes
- Final runs on the test side, including this one: 1
...
| Abstention recall (escalate entries escalated) | 96.2% (76 of 79) |
| Abstention recall, 95% bootstrap CI | [91.1%, 100.0%] (n=79) |
...
| ECE (10 equal-width bins) | 0.026 |
| ECE, 95% bootstrap CI | [0.008, 0.049] (n=198) |
| Brier (multi-class) | 0.048 |
| Brier, 95% bootstrap CI | [0.014, 0.091] (n=198) |
| ECE / Brier before --calibration | n/a |
| Tokens generated per decision, mean / median | 0.0 / 0.0 |
| Time to first decision, cold / warm median / warm p95 | 388 ms / 355 ms / 369 ms |
| Decision latency, cold / warm median / warm p95 | 388 ms / 355 ms / 369 ms |
...
|---|---|---|---|---|---|---|
| read_only | 71 | 71 | 0.033 [0.005, 0.077] (n=71) | 0.065 [0.001, 0.149] (n=71) | 0 of 71 [0.0%, 0.0%] (n=71) | 18.0 / 18.0 |
| mutating | 12 | 12 | 0.005 [0.001, 0.012] (n=12) | 0.000 [0.000, 0.001] (n=12) | 0 of 12 [0.0%, 0.0%] (n=12) | 18.0 / 18.0 |
| escalate_or_explain | 115 | 115 | 0.025 [0.006, 0.052] (n=115) | 0.043 [0.003, 0.090] (n=115) | 0 of 115 [0.0%, 0.0%] (n=115) | 18.0 / 18.0 |
...
| [0.2, 0.3) | 0 | - | - |
| [0.3, 0.4) | 0 | - | - |
| [0.4, 0.5) | 1 | 0.440 | 0.000 |
| [0.5, 0.6) | 0 | - | - |
| [0.6, 0.7) | 0 | - | - |
| [0.7, 0.8) | 0 | - | - |
| [0.8, 0.9) | 1 | 0.855 | 1.000 |
...
| [0.3, 0.4) | 0 | - | - |
| [0.4, 0.5) | 0 | - | - |
| [0.5, 0.6) | 1 | 0.595 | 1.000 |
| [0.6, 0.7) | 1 | 0.648 | 0.000 |
| [0.7, 0.8) | 0 | - | - |
| [0.8, 0.9) | 1 | 0.893 | 1.000 |
| [0.9, 1.0) | 112 | 0.997 | 0.982 |
...
37e017a19623   f7c67c102b08         "llama-server --mode…"   4 seconds ago   Up 4 seconds           127.0.0.1:18090->8080/tcp                     q53-edge
