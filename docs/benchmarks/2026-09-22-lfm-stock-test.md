...
- Command: `scripts/lfm-finetune/measure.py --split $HOME/lfm-train/splits/test.json --final --model LiquidAI/LFM2.5-350M --revision 9e6c6ccf47cd318696e137d381a7ded8fe4df09f --label stock-test --config $HOME/lfm-train/measure-config.toml`
- Split: `$HOME/lfm-train/splits/test.json` (64 entries, 64 sources)
