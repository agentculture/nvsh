# Tier 2 measurement, 2026-09-22: stock-test

- Command: `scripts/lfm-finetune/measure.py --split /home/spark/lfm-train/splits/test.json --final --model LiquidAI/LFM2.5-350M --revision 9e6c6ccf47cd318696e137d381a7ded8fe4df09f --label stock-test --config /home/spark/lfm-train/measure-config.toml`
- Split: `/home/spark/lfm-train/splits/test.json` (64 entries, 64 sources)
...
| Right operation and arguments proposed, per source | 0 of 32 |
| Right operation and arguments proposed, per variation | 0 of 32 |
| Should-escalate asks escalated, per source | 0 of 15 |
| Should-escalate asks escalated, per variation | 0 of 15 |
...
| Explain asks: explained / proposed / escalated, per variation | 15 / 2 / 0 of 17 |
| Mutating proposals on explain asks | 0 |
| Warm latency, median / p95 | 280 ms / 717 ms |
| First request after start | 22.9 s |
| Container memory (`docker stats`) | 3.7 GiB |
| Start-up, including first download | 118.5 s |
...
|    0   N/A  N/A          147875      G   ...rack-uuid=3190708988185955192        292MiB |
+-----------------------------------------------------------------------------------------+
```
