...
Every failure inside nvsh raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`nvsh.cli._output`,
...
# Exit-code policy. Documented in ``nvsh learn`` output.
# 0      = success
