...
| `Ctrl+C` / `Esc` | Pause the agent mid-work with a choice: `[t]` steer, `[s]` stop, `[Esc]` keep going (30 s timeout = keep going). `[s]`, then a further press, kills a harness that ignores it. |
